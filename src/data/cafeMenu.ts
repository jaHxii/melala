...
export const cafeMenu: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Melala Beef Pizza", price: 800 },
      { name: "Melala Cheese Pizza", price: 750 },
      { name: "Tuna Pizza", price: 800 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tuna Sandwich", price: 500 },
      { name: "Beef Wrap", price: 680 },
      { name: "Chicken Wrap", price: 730 },
      { name: "Tuna Wrap", price: 700 },
      { name: "Vegetable Wrap", price: 580 },
      { name: "Egg Sandwich", price: 340 },
      { name: "Vegetable Sandwich", price: 730 },
      { name: "Chicken Club Sandwich", price: 840 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Fasting Machiato", price: 125 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Strawberry Juice", price: 300 },
      { name: "Mixed Juice", price: 345 },
